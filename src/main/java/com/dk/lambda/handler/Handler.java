...
public class Handler implements RequestHandler<APIGatewayProxyRequestEvent, APIGatewayProxyResponseEvent> {
    ...
    public Handler() {
        ...
        controllerMap.put(HttpMethod.PATCH, (i, c) -> {throw new NotSupportedOperationException();});
        controllerMap.put(HttpMethod.HEAD, (i, c) -> {throw new NotSupportedOperationException();});
        controllerMap.put(HttpMethod.DELETE, (i, c) -> {throw new NotSupportedOperationException();});
    }

    @Override
    public APIGatewayProxyResponseEvent handleRequest(APIGatewayProxyRequestEvent input, Context context) {
        try {
            HttpMethod httpMethod = HttpMethod.valueOf(input.getHttpMethod().toUpperCase(Locale.ROOT));
